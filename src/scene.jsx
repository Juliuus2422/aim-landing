...
const PHASE_BADGE = [
  ...
  { label: "analyse", cls: "border-lime-400/30 text-lime-300/90 bg-lime-400/5" },
          ...
          <div key={s} className="flex-1 flex items-center min-w-0">
            ...
            {i < V_STEPS.length - 1 && (
              <div className="h-px flex-shrink-0 w-3 sm:w-6 mx-0.5 mb-4 bg-white/10 relative overflow-hidden">
                <div
                  className="absolute inset-y-0 left-0 bg-lime-400/70 transition-all duration-700"
          ...
          <AnimatePresence mode="wait">
            ...
            {phase === 1 && (
              <motion.div
                ...
                transition={{ duration: 0.35 }}
              >
                <p className="font-mono text-[10px] uppercase tracking-wider text-lime-300/70 mb-2.5">
            ...
            {phase === 4 && (
              ...
              >
                ...
                >
                  <Database size={13} className="text-lime-300 mt-0.5 shrink-0" />
        ...
        {SCENARIOS.map((s, i) => (
          <button
            ...
            className={`font-mono text-[10px] uppercase tracking-wider px-3 py-1.5 rounded-full border transition-all duration-300 cursor-pointer ${
              i === scenario
                ? "border-lime-400/60 text-lime-200 bg-lime-400/10"
